    ...
    open: (tbl) => {
        let func = {
            ...
            find: ({
                ...
                page = 1,
                recordsPerPage = 20
            }, closeMode = func.CLOSE_AFTER_DONE, tbl) => {
                return new Promise((resolve, reject) => {
                    let collection = func.db.collection(tbl || func.tbl);
            ...
            get: (_id, closeMode = func.CLOSE_AFTER_DONE, tbl) => {
                return new Promise((resolve, reject) => {
                    let collection = func.db.collection(tbl || func.tbl);
                    collection.find({
            ...
            insert: (obj, closeMode = func.CLOSE_AFTER_DONE, tbl) => {
                return new Promise((resolve, reject) => {
                    let collection = func.db.collection(tbl || func.tbl);
            ...
            update: (obj0, closeMode = func.CLOSE_AFTER_DONE, tbl) => {
            ...
            delete: (_id, closeMode = func.CLOSE_AFTER_DONE, tbl) => {
                return new Promise((resolve, reject) => {
                    let collection = func.db.collection(tbl || func.tbl);
