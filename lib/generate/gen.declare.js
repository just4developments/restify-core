...
global.GenType = {
        Uuid(mode='db', defaultValue) {
            ...
            Uuid.gen = (fieldName) => {
                ...
                //     return null;
                // };
                if(Uuid.mode === 'code') Uuid.assignInController = Uuid.assignUpController = `body.${fieldName} = ${Uuid.sign}req.body.${fieldName};`;
                else if(Uuid.mode === 'db') Uuid.assignInController = Uuid.assignUpController = `body.${fieldName} = db.uuid(${Uuid.sign}req.body.${fieldName});`;
