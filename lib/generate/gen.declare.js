        ...
        Uuid(mode='db', defaultValue) {
            ...
            Uuid.gen = (fieldName) => {
                ...
                Uuid.validateDeService = (item) => {
                    ...
                    else if(Uuid.mode === 'db') return `${item}.${fieldName} = db.uuid(utils.valid('${fieldName}', ${item}, ${Uuid.type}));`;
                }
                Uuid.validateInService = Uuid.validateUpService = (item) => {
                    ...
                    else if(Uuid.mode === 'db') return `${item}.${fieldName} = db.uuid(utils.valid('${fieldName}', ${item}.${fieldName}, ${Uuid.type}));`;
                }
        ...
        Key(type = GenType.Uuid, defaultValue) {   
            ...
            Key.gen = (fieldName) => {
                ...
                Key.validateDeService = (item) => {
                    ...
                    else if(Key.mode === 'db') return `${item}.${fieldName} = db.uuid(utils.valid('${fieldName}', ${item}, ${Key.type}));`;
                }
                Key.validateUpService = (item) => {
                    if(Key.mode === 'code') return `${item}.${fieldName} = utils.valid('${fieldName}', ${item}.${fieldName}, ${Key.type});`;
                    else if(Key.mode === 'db') return `${item}.${fieldName} = db.uuid(utils.valid('${fieldName}', ${item}.${fieldName}, ${Key.type}));`;
                }
